...
namespace ct
{
     ...
     */
    void CT_EXPORT getTranslationAndEulerAngles(const Eigen::Affine3f& t, float& x, float& y, float& z,
     ...
     */
    bool CT_EXPORT getTransformation(const std::string& text, Eigen::Affine3f& t);
     ...
     */
    Eigen::Affine3f CT_EXPORT getTransformation(float angle, float axisX, float axisY, float axisZ,
