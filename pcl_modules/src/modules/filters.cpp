...
namespace ct
{
    ...
    void Filters::VoxelGrid(float lx, float ly, float lz, Cloud::Ptr& cloud_out, float& time)
    {
        TicToc timer;
        timer.tic();
        Cloud::Ptr cloud_filtered(new Cloud);
    ...
    void Filters::ApproximateVoxelGrid(float lx, float ly, float lz, Cloud::Ptr& cloud_out, float& time)
    {
        TicToc timer;
        timer.tic();
        Cloud::Ptr cloud_filtered(new Cloud);
    ...
    void Filters::StatisticalOutlierRemoval(int nr_k, double stddev_mult, Cloud::Ptr& cloud_out, float& time)
    {
        TicToc timer;
        timer.tic();
        Cloud::Ptr cloud_filtered(new Cloud);
    ...
    void Filters::RadiusOutlierRemoval(double radius, int min_pts, Cloud::Ptr& cloud_out, float& time)
    {
        TicToc timer;
        timer.tic();
        Cloud::Ptr cloud_filtered(new Cloud);
    ...
    void Filters::ConditionalRemoval(ConditionBase::Ptr con, Cloud::Ptr& cloud_out, float& time)
    {
        TicToc timer;
        timer.tic();
        Cloud::Ptr cloud_filtered(new Cloud);
    ...
    void Filters::GridMinimum(float resolution, Cloud::Ptr& cloud_out, float& time)
    {
        TicToc timer;
        timer.tic();
        Cloud::Ptr cloud_filtered(new Cloud);
    ...
    void Filters::LocalMaximum(float radius, Cloud::Ptr& cloud_out, float& time)
    {
        TicToc timer;
        timer.tic();
        Cloud::Ptr cloud_filtered(new Cloud);
    ...
    void Filters::ShadowPoints(float threshold, Cloud::Ptr& cloud_out, float& time)
    {
        TicToc timer;
        timer.tic();
        Cloud::Ptr cloud_filtered(new Cloud);
    ...
    void Filters::DownSampling(float radius, Cloud::Ptr& cloud_out, float& time)
    {
        TicToc timer;
        timer.tic();
        Cloud::Ptr cloud_filtered(new Cloud);
    ...
    void Filters::UniformSampling(float radius, Cloud::Ptr& cloud_out, float& time)
    {
        TicToc timer;
        timer.tic();
        Cloud::Ptr cloud_filtered(new Cloud);
    ...
    void Filters::RandomSampling(int sample, int seed, Cloud::Ptr& cloud_out, float& time)
    {
        TicToc timer;
        timer.tic();
        Cloud::Ptr cloud_filtered(new Cloud);
    ...
    void Filters::ReSampling(float radius, int polynomial_order, Cloud::Ptr& cloud_out, float& time)
    {
        TicToc timer;
        timer.tic();
        Cloud::Ptr cloud_filtered(new Cloud);
        ...
        if (!cloud_->hasNormals())
            mfilter.setComputeNormals(true);
    ...
    void Filters::SamplingSurfaceNormal(int sample, int seed, float ratio, Cloud::Ptr& cloud_out, float& time)
    {
        TicToc timer;
        timer.tic();
        Cloud::Ptr cloud_filtered(new Cloud);
    ...
    void Filters::NormalSpaceSampling(int sample, int seed, int bin, Cloud::Ptr& cloud_out, float& time)
    {
        TicToc timer;
        timer.tic();
        Cloud::Ptr cloud_filtered(new Cloud);
    ...
    void Filters::MedianFilter(int window_size, float max_allowed_movement, Cloud::Ptr& cloud_out, float& time)
    {
        TicToc timer;
        timer.tic();
        Cloud::Ptr cloud_filtered(new Cloud);
    ...
    void Filters::PlaneClipper3D(const Eigen::Vector4f& plane_params, Cloud::Ptr& cloud_out, float& time)
    {
        TicToc timer;
        timer.tic();
        Cloud::Ptr cloud_filtered(new Cloud);
