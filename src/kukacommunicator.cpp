    ...
    double sa, double sb, double sc)
{
    return QStringLiteral(
        ...
        "<SJ5>%7</SJ5><SJ6>%8</SJ6><SE1>%9</SE1></Sensor>")
...
bool KukaCommunicator::parseRobotData(const QString& str, RobotData& data)
{
    ...
    { QStringLiteral("PE1"), QStringLiteral("joint1"), QStringLiteral("joint2"),
      QStringLiteral("joint3"), QStringLiteral("joint4"), QStringLiteral("joint5"),
      QStringLiteral("joint6") };
