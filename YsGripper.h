...
private:
    ...
    std::vector<std::string> listAvailablePorts() const;
    QString formatConnectError(const boost::system::error_code& ec) const;
    bool openAndConfigure(boost::system::error_code& ec);
    bool tryOpenWithRetries(boost::system::error_code& ec);
